...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql', # on utilise l'adaptateur po>
        'NAME': 'muadh', # le nom de notre base de données créée précédemment
        'USER': 'ahmed', # attention : remplacez par votre nom d'utilisateur !!
